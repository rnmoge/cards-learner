...
namespace QuickVerbs
{
    class Verbs
    {
        ...
        //Перенести в БД
        //A
        public const string A11 = "abide", A12 = "abode; abided", A13 = "abode; abided", A14 = "пребывать; держаться";
        public const string A21 = "arise", A22 = "arose", A23 = "arisen", A24 = "подняться; возникнуть";
        public const string A31 = "awake", A32 = "awoke", A33 = "awaked; awoke", A34 = "будить; проснуться";
        //--------------------------------------------------------------------------
        //B
        ...
        {
            get { return secondForm; }
            set { secondForm = value; }
        }
        //--------------------------------------------------------------------------
        string thirdForm;
        ...
        public bool Verbchecked
        {
            get { return verbchecked; }
            set { verbchecked = value; }
        }
        //--------------------------------------------------------------------------
        public Verbs(string AFirstForm, string ASecondForm, string AThirdForm, string ATranslate, int ACategory, bool AVerbchecked)
        {
            FirstForm = AFirstForm;
            secondForm = ASecondForm;
            thirdForm = AThirdForm;
            translate = ATranslate;
            category = ACategory;
            verbchecked = AVerbchecked;
        }
        //--------------------------------------------------------------------------
    }
}
